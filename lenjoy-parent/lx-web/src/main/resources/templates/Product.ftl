...
<div class="i_bg">
    ...
    <div class="content">
        ...
        <div id="tsShopContainer">
            <div id="tsImgS"><a href="${imgUrlList[0]}" title="Images" class="MagicZoom" id="MagicZoom"><img src="${imgUrlList[0]}" width="390" height="390" /></a></div>
                ...
                <div id="tsImgSCon">
                    <ul>
                        ...
                        <#list imgUrlList as imgUrl>
                            <li onclick="showPic(${imgUrl_index})" rel="MagicZoom"><img src="${imgUrl}" tsImgS="${imgUrl}" width="79" height="79" /></li>
                        </#list>
                    </ul>
                </div>
        ...
        <div class="pro_des">
            ...
            <div class="des_choice">
                ...
                <ul>
                    <li class="checked">${color}<div class="ch_img"></div></li>
                </ul>
            </div>
            <div class="des_share">
            	<div class="d_sh">
