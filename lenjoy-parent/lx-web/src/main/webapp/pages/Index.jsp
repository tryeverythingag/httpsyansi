...
<div class="soubg">
    <div class="sou">
        ...
        <!--End 所在收货地区 End-->
        <span class="fr">
        	<span class="fl">你好，请<a href="/static/pages/Login.html">登录</a>&nbsp; <a href="Regist.html" style="color:#ff4e00;">免费注册</a>&nbsp;|&nbsp;<a href="#">我的订单</a>&nbsp;|</span>
        	<span class="ss">
            	<div class="ss_list">
                	<a href="#">收藏夹</a>
...
<div class="top">
    <div class="logo"><a href="Index.html"><img src="<%=basePath %>/static/images/logo.png" /></a></div>
    <div class="search">
        <form>
...
<div class="menu_bg">
    <div class="menu">
        ...
        <!--End 商品分类详情 End-->
       <ul class="menu_r" id="hxMenu">
            <li v-for="temp in hxMenuList"><a v-bind:href="temp.url" v-text="temp.title"></a></li>
        </ul>
        ...
        <script type="text/javascript">
            const vue1 = new Vue({
                ...
                mounted(){
                    this.$http.post("<%=basePath %>/getHxWebMenu.do").then(
                        function(rs){
                            this.hxMenuList=rs.body;
                        }
                    );
                }
            });
...
<div class="i_bg bg_color">
            ...
            <div class="top_slide_wrap">
                <ul class="slide_box bxslider">
                    <c:forEach items="${bannerList}" var="bannerMap">
                        <li><img src="${bannerMap.imgUrl}" width="740" height="401" /></li>
                    </c:forEach>
                </ul>
                ...
                <div id="feature">
                    <div id="block">
                        <div id="botton-scroll">
                            <ul class="featureUL">
                                <c:forEach items="${productDetailList}" var="tempMap">
                                    <li class="featureBox">
                                        <a target="_blank" href="http://localhost:8888/${tempMap.href}">
                                            <div class="box">
                                                <div class="h_icon"><img src="<%=basePath %>/static/images/hot.png" width="50" height="50" /></div>
                                                <div class="imgbg">
                                                    <img src="${tempMap.imgUrlList[0]}" width="160" height="136" />
                                                </div>
                                                <div class="name">
                                                    <h2>${tempMap.title}</h2>
                                                        ${tempMap.subTitle}
                                                ...
                                                <div class="price">
                                                    <font>￥<span>${tempMap.price}</span></font> &nbsp;
                                                </div>
                                            </div>
                                        </a>
                                    </li>
    ...
    <div class="content">
        ...
        <div class="sell_right">
            <%--取左边三张商品--%>
            <c:forEach items="${secKillProductList}" var="map" varStatus="num">
                <c:if test="${num.count+1>=1 and num.count+1<=2}">
                    <div class="sell_${num.count+1}">
                        <div class="s_img"><a href="#"><img src="${map.imgUrlList[0]}" width="185" height="155" /></a></div>
                        <div class="s_price">￥<span>${map.price}</span></div>
                        <div class="s_name">
